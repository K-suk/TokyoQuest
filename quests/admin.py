...
from .models import Quest, Review, SavedQuest, Tag, QuestCompletion, TravelPlan
...
class QuestAdmin(admin.ModelAdmin):
    list_display = ('id', 'title', 'location', 'latitude', 'longitude', 'badget', 'date_created', 'imgUrl', 'exampleUrl')
