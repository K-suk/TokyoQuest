...
class Quest(models.Model):
    ...
    imgUrl = models.URLField(max_length=1000, null=True, blank=True)
    exampleUrl = models.URLField(max_length=1000, null=True, blank=True)
    location = models.CharField(max_length=1000)
    badget = models.CharField(max_length=1000, null=True, blank=True)
